...
new class extends Component {
    ...
    public function openUnit($id)
    {
        ...
        $this->reset(['guest_name', 'guest_phone', 'check_in_time', 'check_out', 'check_out_time', 'total_amount', 'errorMessage']);
    ...
    public function checkAvailability()
    {
        ...
        if ($this->selectedUnitId && $this->check_in && $this->check_out) {
            ...
            if ($this->check_in_time && $this->check_out_time) {
                ...
                $reservations = \App\Models\Reservation::where('unit_id', $this->selectedUnitId)
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="time" wire:model.live="check_in_time" class="w-full rounded-xl border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white shadow-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-colors py-2 px-3 text-sm">
                                ...
                                <div>
                                    ...
                                    <input type="time" wire:model.live="check_out_time" class="w-full rounded-xl border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white shadow-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-colors py-2 px-3 text-sm">
                            ...
                            <div class="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800/30 p-4 rounded-2xl flex justify-between items-center mt-6">
                                <div>
                                    ...
                                    @if($showBreakdown && $this->check_in_time && $this->check_out_time)
                                        ...
                                        @endphp
                                        @if($totalH < 24)
                                            <span class="block text-xs text-zinc-500 dark:text-zinc-400">{{ $totalH }} hora(s) × ${{ number_format($unitForLabel?->price_per_hour ?? 0, 2) }}/hora</span>
                                        @else
                                            @php
