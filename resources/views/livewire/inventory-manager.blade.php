    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        @forelse(collect($units)->filter(fn($u) => $filtro === 'all' || strtolower($u['type']) === $filtro) as $unit)
            <div wire:click="openUnit({{ $unit['id'] }})"
                ...
                <div class="relative w-full aspect-[4/3] bg-[#e8e7df] dark:bg-zinc-800 rounded-[1.5rem] flex items-center justify-center mb-5 overflow-hidden">
                    @if($unit['image'])
    ...
    <flux:modal name="unit-modal" class="md:w-full md:max-w-md">
        @if ($selectedUnitId && isset($units[$selectedUnitId]))
            ...
            <div class="p-6">
                ...
                <div class="relative w-full aspect-[16/9] bg-[#e8e7df] dark:bg-zinc-800 rounded-2xl flex items-center justify-center mb-6 overflow-hidden">
                    @if($su['image'])
