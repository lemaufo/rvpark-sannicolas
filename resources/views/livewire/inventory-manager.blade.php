            ...
            <div class="p-6">
                ...
                <div class="flex flex-col gap-3 pt-4 border-t border-zinc-100 dark:border-zinc-800">
                    ...
                    @else
                        <!-- Reservation Form -->
                        <div class="space-y-4">
                            <p class="text-xs font-bold text-zinc-400 uppercase tracking-widest mb-2">Crear Reservación
                                Activa</p>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label
                                        class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Teléfono
                                        (opcional)</label>
                                    <flux:input wire:model="guest_phone" placeholder="Teléfono" />
                                </div>
                                <div>
                                    <label
                                        class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Total</label>
                                    <flux:input type="number" wire:model="total_amount" placeholder="0.00"
                                        step="0.01" />
                                </div>
                            </div>
