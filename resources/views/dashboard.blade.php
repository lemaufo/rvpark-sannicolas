<x-layouts.app>
    <div class="p-6 lg:p-10 max-w-7xl mx-auto">
        <div class="mb-10 flex items-end justify-between">
            <div>
                <h1 class="text-3xl font-extrabold text-zinc-900 dark:text-white tracking-tight">Panel Principal</h1>
            ...
            @foreach($stats as $stat)
                <div class="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-[2rem] p-7 shadow-sm hover:shadow-md transition-shadow duration-300 group">
                    <div class="flex items-start justify-between">
                        ...
                        <div class="p-4 {{ $stat['bg'] }} rounded-2xl group-hover:bg-zinc-100 dark:group-hover:bg-zinc-700 transition-colors">
                            <flux:icon :name="$stat['icon']" class="size-7 text-zinc-400 dark:text-zinc-500" />
                        </div>
                    </div>
                </div>
            @endforeach
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div class="lg:col-span-2 space-y-8">
                <div class="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-[2.5rem] p-8 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="p-6 border border-zinc-50 dark:border-zinc-800 rounded-3xl bg-[#fcfcfc] dark:bg-zinc-800/50 flex justify-between items-start group hover:border-brand-green/20 transition-colors">
                            <div>
                                <h4 class="font-extrabold text-zinc-900 dark:text-white text-lg">Bungalow Jade</h4>
                                ...
                                <div class="flex items-center gap-2 mt-4">
                                    ...
                                    <p class="text-xs text-zinc-600 dark:text-zinc-300 font-bold">Familia Smith</p>
                                </div>
                            </div>
                ...
                <div class="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-[2.5rem] p-8 shadow-sm">
                    <div class="flex items-center justify-between mb-8">
                        <div class="flex items-center gap-3">
                            <div class="p-2.5 bg-zinc-50 dark:bg-zinc-800 rounded-xl">
                                <flux:icon name="bell" class="size-5 text-zinc-800 dark:text-zinc-200" />
                            </div>
                            <h2 class="text-xl font-black text-zinc-900 dark:text-white tracking-tight">Notificaciones</h2>
                        </div>
                        <span class="size-5 bg-red-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center">2</span>
                    </div>
                    
                    <div class="space-y-6 relative before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-px before:bg-zinc-100 dark:before:bg-zinc-800">
                        <div class="flex gap-5 relative group">
                            <div class="size-10 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 flex items-center justify-center shrink-0 z-10 group-hover:border-brand-green/30 transition-colors shadow-sm">
                                <flux:icon name="exclamation-circle" class="size-5 text-zinc-400" />
                            </div>
                            <div class="pt-1">
                                <p class="text-[13px] font-bold text-zinc-800 dark:text-zinc-200 leading-snug">Recordatorio de salida: RV Spot 8</p>
                        ...
                        <div class="flex gap-5 relative group">
                            ...
                            <div class="pt-1">
                                <p class="text-[13px] font-bold text-zinc-800 dark:text-zinc-200 leading-snug">Pago recibido: $450 - Reserva directa</p>
                                <p class="text-[11px] text-zinc-400 font-bold mt-1 uppercase tracking-wider">Hace 2 horas</p>
                            </div>
                        </div>
                    </div>

                    <button class="w-full mt-8 py-3 bg-zinc-50 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 text-xs font-black uppercase tracking-widest rounded-2xl hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-colors">
